...
const char* ssid = "inxuan";  // insert your SSID
const char* password = "77777777";  // insert your password
...
void ClientRequest(String value1, String value2, String value3) {
  ...
  const char* apiKey = "p8dyN73rUgH-k_0KjoaUYeAAhCgKnFRfmBriqL6gGCH";  //IFTTT Applet key
...
char* ClientRequesta() {
  const char* host = "api.openweathermap.org";
  const char* resource = "/data/2.5/weather?id=1668341&appid=d4a7af4b82766437503a52356191bfcc";
